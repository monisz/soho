    ...
    return (
        <div className="detalle">
            <button className="detalle-volver">
                <Link className="detalle-volver-flecha" to={"/"}>
            ...
            <div className="detalle-izquierda">
                ...
                <div className="detalle-carrito">
                    <div className="detalle-cantidad">
                        <button className="detalle-boton-controles">-</button>
                        <p className="detalle-1">1</p>
                        <button className="detalle-boton-controles">+</button>
                    </div>
                ...
                <p className="detalle-chatea">Chateá con nosotros
